...
collateral:
  ...
  - group: Digital Assets
    items:
      ...
      - src: /locoal_collateral/locoal-logo-spin.mp4
        alt: Spinning Logomark 3D
        label: Spinning Logomark 3D
      ...
      - src: /locoal_collateral/investorPresentation.pdf
        ...
        label: LOCOAL Pitch Deck
      - src: /locoal_collateral/newsletter-may-2025.pdf
        alt: LOCOAL Newsletter May 2025
        label: LOCOAL Newsletter May 2025
  - group: Print Collateral
    items:
      ...
      - src: /locoal_collateral/team-banner.png
        alt: LOCOAL team group photo banner
        label: Team Banner
      - src: /locoal_collateral/hardware-banner.png
        alt: RAINMAKER hardware banner
        label: RAINMAKER hardware banner
        whiteBg: true
