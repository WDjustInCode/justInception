...
You can copy the rules and conventions from this project on GitHub: [headless-wordpress](https://github.com/WDjustInCode/headless-wordpress.git) (`.cursor/rules/headless-wordpress.mdc` and `docs/HEADLESS-WORDPRESS-CONVENTIONS.md`).
...
Rules and conventions on GitHub: [github.com/justinception/headless-wordpress](https://github.com/WDjustInCode/headless-wordpress.git). See `.cursor/rules/` and `docs/HEADLESS-WORDPRESS-CONVENTIONS.md`.
